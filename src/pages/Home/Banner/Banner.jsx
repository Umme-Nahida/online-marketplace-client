...
const Banner = () => {
    return (
        <div className="bg-[url('https://i.ibb.co/7nKPqcQ/digital-online-marketing-businessman-using-260nw-1792952278.webp')] bg-no-repeat bg-cover ">
            {/* navbar */}
            <div className="py-10 px-5 md:py-12 md:px-10 lg:py-24 lg:px-28  bg-[#000000] bg-opacity-40">
                <div className=" navbar-center  text-center" data-aos="fade-up" data-aos-duration="2000">
                    <h1 className=" text-2xl md:text-4xl lg:text-4xl  mb-2 md:mb-8 text-[#ffffff] font-semibold">Our community comprises verified <br /> sellers committed </h1>
